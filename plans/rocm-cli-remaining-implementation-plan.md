...
- The single-file Rust/Cosmopolitan artifact
  ...
  Windows and WSL smoke, TUI smoke, PyTorch local-assistant E2E, Lemonade
  local-assistant E2E, and ComfyUI install/start/status/stop E2E using
